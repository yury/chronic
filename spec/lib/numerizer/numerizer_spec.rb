...
describe Numerizer, :numerize do
	it "handles edges" do
		Numerizer.numerize("27 Oct 2006 7:30am").should == "27 Oct 2006 7:30am"
	end
	it "parses many strings" do
		strings = {
			1 => 'one',
			5 => 'five',
			10 => 'ten',
		...
		strings.each_pair { |k, v| Numerizer.numerize(v).to_i.should == k }
	end
end
